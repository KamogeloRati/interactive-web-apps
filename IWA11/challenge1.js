document.addEventListener("DOMContentLoaded", function () {
    ...
    if (order1Root.dataset.delivered === "true") {
      order1Status.textContent = "Delivered";
    } else {
      order1Status.textContent = "Pending";
    }
  });
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    if (order2Root.dataset.delivered === "true") {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    if (order3Root.dataset.delivered === "true") {
